...
## 4. App Usage Analytics (Google Firebase Analytics)

We use **Google Firebase Analytics** (Google LLC / Google Ireland Limited, depending on region) to understand how the App is used and to improve stability and features.
...
**What we do not send to Firebase Analytics through our integration:**
...
**Retention:** Google retains analytics data according to [Firebase / Google Analytics data retention settings](https://support.google.com/analytics/answer/7667196) configured in our Firebase project.
...
- Purchases, renewals, refunds, and subscription management are processed by **Apple** through your **Apple ID**, not by Snorry or Lintech AS.
- Snorry **does not** collect, receive, or store your payment card number, bank account details, billing address, or other financial information.
- We do **not** operate our own billing or customer account system for subscriptions. Snorry does not require you to create a separate Snorry account.
